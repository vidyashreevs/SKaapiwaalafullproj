...
public class StrongTea extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.strong_tea);
        ...
        //To send *RE# cmd while opening blacktea page and if bluetooth is connected then kaapiwaala tab will turn to green
       try{
        runOnUiThread(new Runnable() {
           ...
           e.printStackTrace();
           //Toast.makeText(StrongTea.this, "Connection Problem", Toast.LENGTH_SHORT).show();
       }
...
/////////////////////////////////////////////////////////////////
                ...
                {
                    AlertDialog.Builder alertBuilder = new AlertDialog.Builder(StrongTea.this);
        ...
        bback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent  i=new Intent(StrongTea.this, Operatorsettings.class);
                startActivity(i);
                finish();
            }
        });
                            ...
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    ...
                                    if (message.equals("*CON#")) {
                                       // Toast.makeText(StrongTea.this, "Device Connected", Toast.LENGTH_SHORT).show();
                                        lcon.setBackgroundResource(R.drawable.kapiconect);
                                    } else if (message.equals("*NOC#")) {
                                       // Toast.makeText(StrongTea.this, "Device Busy,not connected", Toast.LENGTH_SHORT).show();
                                        lcon.setBackgroundResource(R.drawable.kaapiwala_tab);
                                    } else if (message.equals("*DCN#")) {
                                       // Toast.makeText(StrongTea.this, "Device disconnected", Toast.LENGTH_SHORT).show();
                                        lcon.setBackgroundResource(R.drawable.kaapiwala_tab);
                                    }
                                    else if(message.equals("*O5#")) {
                                        Toast.makeText(StrongTea.this, "Data Received", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                            break;
