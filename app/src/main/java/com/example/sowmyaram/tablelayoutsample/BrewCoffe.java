...
public class BrewCoffe extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.brew_coffee);
            ...
            public void onClick(View v) {
                try {
                    if (inputField.length() > 0 && inputField.getText().toString().contains(".")) {
                        ...
                        if(part2int>59){
                           // Toast.makeText(BrewCoffe.this, "Invalid", Toast.LENGTH_SHORT).show();

                            AlertDialog.Builder alertBuilder = new AlertDialog.Builder(BrewCoffe.this);
        ...
        bback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent  i=new Intent(BrewCoffe.this, Operatorsettings.class);
                startActivity(i);
                finish();
            }
        });
                        ...
                        if ((message.startsWith("*")) && (message.endsWith("#"))  && message.length() == 5) {
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    ...
                                    else  if(message.equals("*BRC#")) {
                                        Toast.makeText(BrewCoffe.this, "Data Received", Toast.LENGTH_SHORT).show();
                                    }
