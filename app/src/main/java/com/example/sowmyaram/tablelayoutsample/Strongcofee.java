...
public class Strongcofee extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.strong_coffee);
        ...
        //To send *RB# cmd while opening blacktea page and if bluetooth is connected then kaapiwaala tab will turn to green
         try{
        runOnUiThread(new Runnable() {
            ...
            public void run() {
             ...
             e.printStackTrace();
           //  Toast.makeText(Strongcofee.this, "Connection Problem", Toast.LENGTH_SHORT).show();
         }

        /* etsugarv.addTextChangedListener(new TextWatcher() {
                                                ...
                                                if (!ignoreChange) {
                                                    ...
                                                    if (parts.length > 1) {
                                                        ...
                                                        if (digitsAfterPoint.length() > 1) {
                                                            ignoreChange = true;
                                                            etsugarv.setText(string.substring(0, string.indexOf(".") + 2));
                                                            etsugarv.setSelection(etsugarv.getText().length());
                                                            ignoreChange = false;
                                                        }
                                                    }

                                                    String strValue = etsugarv.getText().toString();
                                                    float value = Float.valueOf(strValue);
                                                    if (value < 1 || value > 120) {
                                                        ignoreChange = true;
                                                        etsugarv.setText(beforeChange);
                                                        etsugarv.setSelection(etsugarv.getText().length());
                                                        ignoreChange = false;
                                                    }
                                                    beforeChange = etsugarv.getText().toString();
                                                }
...
/////////////////////////////////////////////////////////////////
                ...
                {
                    AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Strongcofee.this);
        ...
        bback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent  i=new Intent(Strongcofee.this, Operatorsettings.class);
                startActivity(i);
                finish();
            }
        });
                            ...
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    ...
                                    if (message.equals("*CON#")) {
                                       // Toast.makeText(Strongcofee.this, "Device Connected", Toast.LENGTH_SHORT).show();
                                        lcon.setBackgroundResource(R.drawable.kapiconect);
                                    } else if (message.equals("*NOC#")) {
                                       // Toast.makeText(Strongcofee.this, "Device Busy,not connected", Toast.LENGTH_SHORT).show();
                                        lcon.setBackgroundResource(R.drawable.kaapiwala_tab);
                                    } else if (message.equals("*DCN#")) {
                                        //Toast.makeText(Strongcofee.this, "Device disconnected", Toast.LENGTH_SHORT).show();
                                        lcon.setBackgroundResource(R.drawable.kaapiwala_tab);
                                    }

                                    else if(message.equals("*O2#")) {
                                        Toast.makeText(Strongcofee.this, "Data Received", Toast.LENGTH_SHORT).show();
